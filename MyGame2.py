...
def fight():
    ...
    while enemyHP > 0 and playerHP > 0:
        print ('---------------------------------------------')
        print ('|--Player Level[', playerLevel,']---''  ''---', enemy, '--|')
        print ('---------------------------------------------')
        print ('[HP] :',playerHP,'          [HP] :', enemyHP)
        print ('[ATK]:',playerAtk,'          [ATK]:', enemyAtk)
        print ('[DEF]:',playerDef,'           [DEF]:', enemyDef)
        print ('------------------------------------------')
        print ('[EXP]:',playerExp, '    [GOLD]:', playerGold)
        print ('------------------------------------------')
