...
Player1 = Player(playername, 0, 100, 5, 1, 0, 100, 6660, 1)
...
def moveEnc():
    while Player1.hp >= 0: #BUG - instead of true, it has to be wihle player hp > 0 i think... i got to 0 and hit an infinite explore loop. ... still not working :(:(:(
        battle = (random.randint(1, 14))
        print("battle_number:", battle)
...
def mainMenu():
    ...
    print('WORKING ON IMPLEMENTING A SAVE/LOAD SYSTEM USING PICKLE IN VER: 0.6')
    print('---------------------------------------------------')
    print('          Instructions')
    print('---------------------------------------------------')
